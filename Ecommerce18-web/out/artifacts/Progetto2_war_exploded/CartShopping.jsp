                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td><div class="col-sm-12 col-md-6 text-right">
                                ...
                                <!--Nel caso in cui il carrello è vuoto il pulsante checkout è disabilitato-->
                                    <button  class="btn  btn-success " disabled>Checkout</button >
                                <%} else {%>
                                <!--Invio il prezzo da pagare alla pagina checkout.jsp e una viarabile di controllo -->
